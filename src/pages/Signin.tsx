...
export function SignIn() {
  ...
  return(
    <div
    className='flex-col h-screen w-screen bg-gray-900 flex items-center justify-center text-gray-100'
   >
    ...
    <form className="flex flex-col items-stretch w-full max-w-sm gap-4 mt-9" onSubmit={handleSignIn}>
      { isUserSignedIn && <Text>Login realizado!</Text> }
      <label htmlFor="email"  className="flex flex-col gap-3">
        <Text className="font-semibold">Endereço de e-mails</Text>
        <TextInput.Root>
          <TextInput.Icon>
            <Envelope />
          </TextInput.Icon>
